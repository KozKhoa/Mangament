...
import FilterRoles from "@/components/filters/filter-roles";
import FilterGenders from "@/components/filters/filter-genders";
          ...
          <div className="flex flex-col gap-4 justify-center items-center ">
            ...
            <div className="flex flex-row flex-wrap gap-2 w-full justify-between">
              ...
              <div className="flex flex-row flex-wrap gap-2 justify-start items-center h-full">
                ...
                <FilterGenders value={gender ?? []} onChange={(genders) => handleNavigate("gender", genders?.join(","))} />
            ...
            {loadingUsers ? (
              ...
              <>
                <UserTable className="w-full shadow-md overflow-x-scroll" data={users} pagination={usersPagination} />
                <SwitchPageBig
                  maxPage={usersPagination?.totalPages ?? 0}
                  page={page}
                  onChange={(page) => handleNavigate("page", page.toString())}
